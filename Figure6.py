...
def plot_param(param,axis,axis1,axis2,axis3,axis_cb,axis_cb_sed):
    ...
    CS_farm_sed = axis3.contourf(X_sed,Y_sed, z_farm[sed2:,:], nlev, extend="both")
    ...
    axis2.axhline(0,linestyle = '--',linewidth = 0.3,color = 'w')
    axis3.axhline(0,linestyle = '--',linewidth = 0.3,color = 'w') 
...
gs = gridspec.GridSpec(5, 2,width_ratios = [25,1]) 
